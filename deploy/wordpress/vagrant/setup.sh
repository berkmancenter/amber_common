...
RewriteEngine on
RewriteRule ^.*amber/cache/([a-f0-9]+)/?$ /~jlicht/wp1/index.php?amber_cache=$1 [L,QSA]
RewriteRule ^.*amber/cacheframe/([a-f0-9]+)/?$ /~jlicht/wp1/index.php?amber_cacheframe=$1 [L,QSA]
RewriteRule ^.*amber/cacheframe/([a-f0-9]+)/assets/(.*)/?$ /~jlicht/wp1/index.php?amber_cacheframe=$1&amber_asset=$2 [L,QSA]
EOF
